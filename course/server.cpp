...
int main()
{
    int sockMain = 0, clientSock, innersock = 0, insckin, cnct, chk;
    fd_set fd_old, fd_upd;
    std::vector<int> f_recv, innersocks, clients;
    std::vector<std::wstring> logins, passwords;
